...
DIR = "D:\\Experiment\\Binary Classifier\\dataset\\"
PATH = "D:\\Experiment\\Binary Classifier\\"
...
def main():
	...
	modelPath = PATH + 'VGG_BinaryClassifier.hdf5'
...
def testing(testX, testY, modelPath):
	...
	predictedClass = ['scarlet' if a < 0.5 else 'zinia' for a in predictions] 
	actualClass = ['scarlet' if a < 0.5 else 'zinia' for a in testY]	
...
def training(trainX, trainY, modelPath, imgH, imgW):
	...
	figPath = PATH + 'Training_Vs_Val_Loss.png'
